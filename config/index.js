...
module.exports = {
  build: {
    ...
    assetsSubDirectory: '',
    assetsPublicPath: '/',
    assetsPublicPathC2C: 'https://fe-static.sayabc.com/minichallengegame/static/', // 正式环境cdn
  ...
  dev: {
    ...
    assetsSubDirectory: '',
    assetsPublicPath: '/',
    assetsPublicPathC2C: 'https://fe-static.sayabc.com/minichallengegame/static1/', // 测试环境cdn
    proxyTable: {},
