...
// c2c定制化配置---
exports.assetsPublicPathForC2C = function () {
    var assetsSubDirectory

    if (process.env.CURENV === 'local') {
        assetsSubDirectory = config.dev.assetsPublicPath
    } else if (process.env.CURENV === 'test') {
        assetsSubDirectory = config.dev.assetsPublicPathC2C
    } else {
        assetsSubDirectory = config.build.assetsPublicPathC2C
    }
